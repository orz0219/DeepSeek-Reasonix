...
var reComposeBlock = regexp.MustCompile(`(?s)^\s*<(?:memory-update|background-jobs|active-goal|execution-policy)(?:\s+[^>]*)?>.*?</(?:memory-update|background-jobs|active-goal|execution-policy)>\s*\n`)
