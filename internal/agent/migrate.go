...
// no watermark to compare against — full passes own this dir

// surfaced only through their parent session

// written before the last migration — not a downgrade straggler

// global session, or no live workspace — leave it in the flat dir

// already routed on a previous boot

// preserve resume ordering
